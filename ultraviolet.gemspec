...
Gem::Specification.new do |s|
  ...
  s.date = %q{2010-02-15}
  s.description = %q{This is a fixed version of the Ultraviolet syntax highlighting library for the 1.9 tree of the Ruby programming language. There are still some languages that are not working, but hopefully will be soon. If you find any bugs, or fix any syntax files, please send me a note and I'll update the repository.}
  ...
  s.summary = %q{This is a fixed version of the Ultraviolet syntax highlighting library for the 1.9 tree of the Ruby programming language}
  s.test_files = ["test/test_ultraviolet.rb", "test/test_uv.rb"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<textpow>, [">= 0.11.0"])
      s.add_development_dependency(%q<rubyforge>, [">= 2.0.3"])
      s.add_development_dependency(%q<gemcutter>, [">= 0.3.0"])
      s.add_development_dependency(%q<hoe>, [">= 2.5.0"])
    else
      s.add_dependency(%q<textpow>, [">= 0.11.0"])
